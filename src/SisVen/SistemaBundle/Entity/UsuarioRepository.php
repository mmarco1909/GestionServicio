...
class UsuarioRepository extends EntityRepository {
     ...
     */
    public function ajaxTable(array $get, $flag = false, $matricula) {

        /* Indexed column (used for fast and accurate table cardinality) */
        $alias = 'a';

        /* DB table to use */
        $tableObjectName = 'SistemaBundle:Usuario';
        ...
        $cb = $this->getEntityManager()
            ...
            ->where($alias.".idUsuarioLider = :user_id")
    ...
    public function getCount() {
        $aResultTotal = $this->getEntityManager()
                ->createQuery('SELECT COUNT(a) FROM SistemaBundle:Usuario a')
                ->setMaxResults(1)
                ->getResult();
     ...
     * @return int
     */
    public function getNroAsesores($matricula) {

        $aResultTotal = $this->getEntityManager()
                ->createQuery('SELECT COUNT(a) FROM SistemaBundle:Usuario a'
                        . ' where a.idUsuarioLider= :matricula')
