...
/**
 * ReporteSupervisorRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class ReporteSupervisorRepository extends EntityRepository {
     ...
     */
    public function ajaxreporteTable(array $get, $flag = false, $matricula) {

        /* Indexed column (used for fast and accurate table cardinality) */
        $alias = 'up';

        /* DB table to use */
        $tableObjectName = 'SistemaBundle:ReporteSupervisor';
    ...
    public function getCount() {
        $aResultTotal = $this->getEntityManager()
                ->createQuery('SELECT COUNT(a) FROM SistemaBundle:ReporteSupervisor a')
                ->setMaxResults(1)
                ->getResult();
