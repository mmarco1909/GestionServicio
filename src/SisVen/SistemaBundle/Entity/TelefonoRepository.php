...
class TelefonoRepository extends EntityRepository {
     ...
     */
    public function ajaxtelefonoTable(array $get, $flag = false, $matricula, $cuspp) {

        /* Indexed column (used for fast and accurate table cardinality) */
        $alias = 'up';

        /* DB table to use */
        $tableObjectName = 'SistemaBundle:Telefono';
    ...
    public function getCount() {
        $aResultTotal = $this->getEntityManager()
                ->createQuery('SELECT COUNT(a) FROM SistemaBundle:Telefono a')
                ->setMaxResults(1)
                ->getResult();
