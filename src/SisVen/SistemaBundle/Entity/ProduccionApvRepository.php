...
/**
 * ProduccionApvRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class ProduccionapvRepository extends EntityRepository {
     ...
     */
    public function ajaxapvTable(array $get, $flag = false, $matricula, $producto) {

        /* Indexed column (used for fast and accurate table cardinality) */
        $alias = 'up';

        /* DB table to use */
        $tableObjectName = 'SistemaBundle:ProduccionApv';
    ...
    public function getCount() {
        $aResultTotal = $this->getEntityManager()
                ->createQuery('SELECT COUNT(a) FROM SistemaBundle:ProduccionApv a')
                ->setMaxResults(1)
                ->getResult();
